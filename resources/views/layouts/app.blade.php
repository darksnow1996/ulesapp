...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Ules Payment Portal</title>
        <!-- Favicon -->
...
/*
                    ...
                    $.ajax({
                        beforeSend: function (request) {
                            request.setRequestHeader("Content-Type", file_data.type);
                        },
                        async:false,
                ...
                $('#fee_id').change(function () {
                    ...
                    $.ajax({
                        ...
                        success: function(result){
                            ...
                            $('#total_amount1').val(result.amount * 100);

                            $('#metadata').val(JSON.stringify({'student_id': $('#student_id').val(), 'fee_id' : $('#fee_id').val()}));
