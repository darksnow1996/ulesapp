        ...
        <form class="form" method="post" action="{{ route('login') }}">
           {{csrf_field()}}
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    <p class="text-dark mb-2">Login to Ules Payment Portal</p>
                    <div class="input-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                        ...
                        <input type="text" name="matric_no" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ _('Enter Matric No') }}">
